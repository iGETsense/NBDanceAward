...
export default function ReglesPage() {
  ...
  const criteriaSection = useScrollAnimation()
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <div className="pt-[108px]">
        {/* Hero Section */}
        <section ref={heroSection.ref as any} className="relative py-16 md:py-24 bg-gradient-to-b from-zinc-900/50 to-[#0a0a0a]">
        ...
        {/* About Section */}
        <section ref={aboutSection.ref as any} className="py-12 md:py-16 md:border-t md:border-zinc-800">
          <div className="container mx-auto px-4 md:px-6">
        ...
        {/* Categories Section */}
        <section ref={categoriesSection.ref as any} className="py-12 md:py-16 bg-zinc-900/30 border-t border-zinc-800">
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-4xl mx-auto">
              <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 mb-6 sm:mb-8">
        ...
        {/* Criteria Section */}
        <section ref={criteriaSection.ref as any} className="py-12 md:py-16 border-t border-zinc-800">
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-4xl mx-auto">
              <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 mb-6 sm:mb-8">
        ...
        <section ref={targetSection.ref as any} className="py-12 md:py-16 bg-zinc-900/30 border-t border-zinc-800">
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-4xl mx-auto">
              <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 mb-6 sm:mb-8">
